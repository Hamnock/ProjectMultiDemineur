...
audioF = new Audio("sounds/Flag.mp3")
var time = 0;
...
function click_on_case() {
  ...
  ma_case = document.getElementById("gameTable").children[position.y].children[position.x];
  console.log(this)
  ...
  for (i = 0; i < hauteur; i++) {
    for (j = 0; j < largeur; j++) {
      ...
      if (cases[i][j] == document.getElementById("gameTable").children[position.y].children[position.x]) {
        degage_case(i, j);
      }
    }
  }
...
function context_on_case() {
  ...
  var caseici = document.getElementById("gameTable").children[position.y].children[position.x];
...
var color = "#6f6f6f"
function move() {
    document.getElementById("gameTable").children[position.y].children[position.x].style.background = color
    switch (dir) {
        case "bas":
            position.y++
            break;
    ...
    color = document.getElementById("gameTable").children[position.y].children[position.x].style.background
  ...
  switch (event.keyCode) {
    ...
    case 16:
      ...
      if (!caseici.classList.contains("drapeau")) {
        var htmldrap = "<img src=\"img/drapeau.gif\" width=\"" + TAILLE_IMG + "\" height=\"" + TAILLE_IMG + "\">";
